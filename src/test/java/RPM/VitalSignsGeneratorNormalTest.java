...
public class VitalSignsGeneratorNormalTest {
    VitalSignsGenerator generator = new VitalSignsGenerator(0);
    ...
    //these are the bounds for the normal condition
    int maxHR = 100; int minHR = 40;
    int maxRR = 23;  int minRR = 10;
    int maxTemp = 39; int minTemp = 35;
    int maxSyst = 135; int minSyst = 95;
